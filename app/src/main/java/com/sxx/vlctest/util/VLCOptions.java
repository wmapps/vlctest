...
public class VLCOptions {
    ...
    @SuppressWarnings("unused") public static final int HW_ACCELERATION_AUTOMATIC = -1;
    ...
    public static ArrayList<String> getLibOptions(@NonNull Context context) {
        ...
        final boolean verboseMode = false;//pref.getBoolean("enable_verbose_mode", true);
    ...
    public static void setMediaOptions(Media media, @NonNull Context context, int flags) {
        ...
        if (!noHardwareAcceleration) {
            try {
                final SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
                final String value = pref.getString("hardware_acceleration", "-1");
                if (value != null) {
                    hardwareAcceleration = Integer.parseInt(value);
                }
            } catch (NumberFormatException ignored) {
            }
        }
    ...
    @MainThread
    public static MediaPlayer.Equalizer getEqualizer(@NonNull Context context) {
        final SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public static int getEqualizerPreset(@NonNull Context context) {
        final SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        return pref.getInt("equalizer_preset", 0);
    }

    public static void setEqualizer(@NonNull Context context, MediaPlayer.Equalizer eq, int preset) {
        final SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
